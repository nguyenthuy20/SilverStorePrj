...
<?php startblock('content') ?>
    ...
    <div class="my-account-area">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="heading-title">QUẢN LÝ TÀI KHOẢN </h1>
                    <p>Chào mừng đến với tài khoản của bạn. Tại đây bạn có thể quản lý tất cả các thông tin cá nhân và đơn đặt hàng của mình.</p>
                </div>
            </div>
            <div class="row">
