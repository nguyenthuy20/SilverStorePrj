                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="/admin/ManageProduct/Create" enctype="multipart/form-data">
                            ...
                            <div class="mt-4">
                                ...
                                <!--                                <a style="color: white; padding: 0px;"  href="?controller_ad=products" class="btn btn-link">Thêm</a>-->
                                <!--                            </button>-->
                                <a href="/index_products" class="btn btn-link">Quay lại</a>
                            </div>
                        </form>
                        <!-- /Form -->
                    </div>
